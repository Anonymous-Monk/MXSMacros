 ...
 *  @return 是否成功替换（或增加）
 */
RH_EXTERN bool acObjc_ReplaceMethodInTwoClasses(Class _fromClass, SEL _originSelector, Class _toClass, SEL _newSelector) {
...
RH_EXTERN bool acObjc_ReplaceMethod(Class _class, SEL _originSelector, SEL _newSelector) {
    return acObjc_ReplaceMethodInTwoClasses(_class, _originSelector, _class, _newSelector);
}
 ...
 */
RH_EXTERN bool acObjc_OverrideImplementation(Class targetClass, SEL targetSelector, id (^implementationBlock)(Class originClass, SEL originCMD, IMP originIMP)) {
 ...
 */
RH_EXTERN BOOL acObjc_ExtendImplementationOfVoidMethodWithoutArguments(Class targetClass, SEL targetSelector, void (^implementationBlock)(__kindof NSObject *selfObject)) {
    return acObjc_OverrideImplementation(targetClass, targetSelector, ^id(Class originClass, SEL originCMD, IMP originIMP) {
